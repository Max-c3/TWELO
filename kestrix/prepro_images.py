...
#Defining the inputs for the function (2)
...
def splitting_into_compartments(tensor):
  ...
  whole image (+ padding on each side of 70 pixels)
  that is supposed to be split into compartments.
  The tensor should thus have the shape (4140, 3140, 3)
  '''
...
# Can be put into a function as well - potentially function (3)

# def saving_compartments(compartment_tensors):
